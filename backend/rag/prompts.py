...
RAG_PROMPT_WITH_HISTORY = """Tu es l'assistant de support de PALO Platform. Utilise le contexte fourni pour répondre à la question de manière directe et concise.
